...
int main()
{
	...
	catch (Exception& e)
	{
		...
		window3.create(VideoMode(600, 400), "Message Error", Style::Default);
		error.setFont(font2);
		error.setCharacterSize(40);
		error.setPosition(100, 160);
		...
		std::cout << error.getString().toAnsiString() << endl;
		return -1;
	}
